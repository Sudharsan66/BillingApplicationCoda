...
//		session.invalidate();
	...
	@RequestMapping(value="/Oneregistration",method = RequestMethod.GET)
	public String Oneregistration() {
	...
	public String userLogin(@RequestParam String uname, @RequestParam String upass, HttpSession session,HttpServletRequest request) {
	    ...
	    if(result.equals("valid")) {
			...
			ActionMsg error = new ActionMsg("The password is wrong Please Check Your Password");
